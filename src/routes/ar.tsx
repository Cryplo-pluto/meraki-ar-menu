  ...
  head: () => ({
    meta: [
      { title: "Our AR Menu — See Your Meal Before You Order | Meraki Cafe" },
      {
        name: "description",
        content:
          "Meraki's AR menu shows every dish on your own table at its actual serving size. Works on iPhone and Android — no app needed.",
      },
    ...
    <div className="container-page py-16">
      <header className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground">
          Every dish on our menu can be placed, at actual serving size, on your own table using your
          phone camera. No app to install — just tap "View in AR".
        </p>
      </header>
      ...
      <ol className="mx-auto mt-16 grid max-w-4xl gap-6 md:grid-cols-3">
        <li className="rounded-2xl border border-border/60 bg-card p-6 warm-shadow">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Scan a QR at your table or tap any food photo on our menu.
          </p>
        </li>
        <li className="rounded-2xl border border-border/60 bg-card p-6 warm-shadow">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Then slowly point your camera at the table. That's it.
          </p>
        </li>
        <li className="rounded-2xl border border-border/60 bg-card p-6 warm-shadow">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Walk around it, get closer — then order when you're hungry.
          </p>
        </li>
      </ol>

      <p className="mx-auto mt-12 max-w-2xl text-center text-sm text-muted-foreground">
        Sizes shown are true to what arrives. We show a representative dish for each size class —
        plating may vary, but the portion doesn't.
      </p>
