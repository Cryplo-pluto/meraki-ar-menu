...
export const Route = createFileRoute("/cakes/$slug")({
  ...
  head: ({ params, loaderData }) => {
    ...
    return {
      meta: [
        ...
        {
          name: "description",
          content: `${it.name}. ${it.dimensions_label}. Order by 12:00 for next-day collection or delivery across Lusaka.`,
        },
  ...
  notFoundComponent: () => (
    <p className="container-page py-24">This cake isn't available right now.</p>
  ),
});
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            Representative cake shown at true size; final decoration may vary.
          </p>
        </div>
        <div>
