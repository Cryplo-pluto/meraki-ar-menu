  ...
  head: () => ({
    meta: [
      { title: "Locations — Meraki Cafe Lusaka" },
      {
        name: "description",
        content:
          "Meraki Cafe has three homes in Lusaka: Rhodespark, Eastpark and Kabulonga. Open daily 07:00–21:00.",
      },
    ...
    <div className="container-page py-12">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        {branches.map((b) => (
          <article
            key={b.slug}
            className="flex flex-col rounded-2xl border border-border/60 bg-card p-6 warm-shadow"
          >
            ...
            <div className="mt-6 flex flex-col gap-2">
              {b.phone && (
                <a
                  ...
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:brightness-110"
                >
              ...
              <Link
                to="/locations/$slug"
                params={{ slug: b.slug }}
                className="min-h-11 rounded-full border border-border px-4 py-2 text-center text-sm font-semibold text-foreground hover:bg-muted"
              >
                Branch details
              </Link>
            </div>
