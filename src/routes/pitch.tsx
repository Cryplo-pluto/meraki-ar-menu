...
export const Route = createFileRoute("/pitch")({
  component: PitchPage,
  head: () => ({
    meta: [{ title: "Meraki — Pitch Overview" }, { name: "robots", content: "noindex, nofollow" }],
  }),
      ...
      <div className="container-page py-12">
        <header className="mb-10">
          ...
          <p className="mt-3 max-w-2xl text-[color:var(--muted-foreground)]">
            A one-screen tour of the working Meraki concept build. Every capability below is live in
            this demo — try it on the projector, then scan the QR on your phone.
          </p>
        </header>
